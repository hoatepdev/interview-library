/**
 * Seed Script for Senior-Level Docker and DevOps Interview Questions
 *
 * Usage:
 *   npx ts-node -r tsconfig-paths/register src/database/seeds/seed-senior-docker-devops.ts
 *   or: pnpm --filter backend seed:senior-docker-devops
 *
 * Adds 10 senior-level Docker and DevOps questions.
...
async function runSeed() {
  console.log("🌱 Starting senior-level Docker and DevOps questions seed...");
  ...
  try {
    ...
    console.log("❓ Adding senior-level Docker and DevOps questions...");
    let added = 0;
    let skipped = 0;
