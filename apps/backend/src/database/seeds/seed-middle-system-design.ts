/**
 * Seed Script for Middle-Level System Design Interview Questions
 *
 * Usage:
 *   npx ts-node -r tsconfig-paths/register src/database/seeds/seed-middle-system-design.ts
 *   or: pnpm --filter backend seed:middle-system-design
 *
 * Adds 20 middle-level System Design questions.
...
import { middleSystemDesignQuestions } from "./interview-data-middle-system-design";

const topicSlugToId: Record<string, string> = {};

async function runSeed() {
  console.log("🌱 Starting middle-level System Design questions seed...");
  ...
  try {
    ...
    console.log("❓ Adding middle-level System Design questions...");
    let added = 0;
    let skipped = 0;

    for (const questionData of middleSystemDesignQuestions) {
