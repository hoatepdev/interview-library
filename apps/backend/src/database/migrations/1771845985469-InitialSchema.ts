...
export class InitialSchema1771845985469 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."questions_level_enum" AS ENUM('junior', 'middle', 'senior')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "topic_translations" ADD CONSTRAINT "FK_8b60e14fa5f4dfab0dd3c0a1ae0" FOREIGN KEY ("topic_id") REFERENCES "topics"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "question_translations" ADD CONSTRAINT "FK_d75f04dea96ed72c62407be69c8" FOREIGN KEY ("question_id") REFERENCES "questions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_questions" ADD CONSTRAINT "FK_7df0da6b1f94c132a9fbed5155c" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_questions" ADD CONSTRAINT "FK_d253957ec0f958b71ddc6881f06" FOREIGN KEY ("question_id") REFERENCES "questions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "practice_logs" ADD CONSTRAINT "FK_b8287c05e7ed7473687ca541bc0" FOREIGN KEY ("question_id") REFERENCES "questions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "practice_logs" ADD CONSTRAINT "FK_55e31a1c49a95a4f85093b089a8" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "questions" ADD CONSTRAINT "FK_e29a77ea64df3fb567c4c200a9e" FOREIGN KEY ("topic_id") REFERENCES "topics"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "practice_logs" DROP CONSTRAINT "FK_55e31a1c49a95a4f85093b089a8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "practice_logs" DROP CONSTRAINT "FK_b8287c05e7ed7473687ca541bc0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_questions" DROP CONSTRAINT "FK_d253957ec0f958b71ddc6881f06"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_questions" DROP CONSTRAINT "FK_7df0da6b1f94c132a9fbed5155c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "question_translations" DROP CONSTRAINT "FK_d75f04dea96ed72c62407be69c8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "topic_translations" DROP CONSTRAINT "FK_8b60e14fa5f4dfab0dd3c0a1ae0"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."practice_logs_self_rating_enum"`,
    );
    await queryRunner.query(`DROP TABLE "user_questions"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b530665e62ed5680a75cbf134e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3bddf2aa22a092dcad615d9ddb"`,
    );
    await queryRunner.query(`DROP TABLE "question_translations"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4e862c0f575adafc6a9030d975"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2062b496508bc3547531a76239"`,
    );
