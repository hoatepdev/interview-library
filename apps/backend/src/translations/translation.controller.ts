...
export class TranslationController {
  ...
  updateQuestionTranslation(
    ...
    return this.translationService.updateQuestionTranslation(
      questionId,
      locale,
      dto,
    );
  ...
  getMissingTranslations(
    @Param("entityType") entityType: "topics" | "questions",
    @Param("locale") locale: Locale,
  ) {
