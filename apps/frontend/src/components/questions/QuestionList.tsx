  ...
  if (questions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4 text-center bg-white/50 dark:bg-slate-900/50 backdrop-blur-md rounded-3xl border border-slate-200/50 dark:border-white/5">
        ...
        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">{tCommon('noData')}</h3>
              ...
              {question.topic && (
                <span
                  ...
                  style={{
                    ...
                    borderColor: question.topic.color ? `${question.topic.color}30` : 'rgba(148, 163, 184, 0.2)',
