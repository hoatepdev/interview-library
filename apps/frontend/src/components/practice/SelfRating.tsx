    ...
    <div className="mt-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        >
          ...
          <span className="text-sm font-semibold">{t("ratings.poor")}</span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-sm font-semibold">{t("ratings.fair")}</span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-sm font-semibold">{t("ratings.good")}</span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-sm font-semibold">{t("ratings.great")}</span>
        </button>
      </div>
    </div>
  );
