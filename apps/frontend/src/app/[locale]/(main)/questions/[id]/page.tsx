...
function QuestionDetailContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="gap-1.5 rounded-full text-slate-500 hover:text-violet-600 dark:hover:text-violet-400"
            title={isVietnamese ? t("showOriginal") : t("translateToVi")}
          >
            {isTranslating ? (
      ...
      {translationError && (
        <div className="text-sm text-red-500 bg-red-50 dark:bg-red-500/10 px-4 py-2 rounded-lg">
          {t("translationError")}
        </div>
      )}
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {(question.answer || displayAnswer) && (
            <div className="bg-blue-500/5 dark:bg-blue-500/10 backdrop-blur-xl p-8 rounded-2xl border border-blue-500/20 dark:border-blue-400/10 shadow-sm">
              ...
              <div className="prose prose-slate dark:prose-invert max-w-none">
                <RichTextPreview
                  content={normalizeAnswer(displayAnswer ?? question.answer ?? "")}
                  className="text-slate-700 dark:text-slate-300 leading-relaxed"
                />
              </div>
            </div>
