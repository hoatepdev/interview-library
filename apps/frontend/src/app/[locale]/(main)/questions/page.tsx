  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6">
        <div>
          <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-liner-to-r from-slate-900 to-slate-600 dark:from-white dark:to-slate-400">
            {t("title")}
          </h1>
        ...
        <div className="flex flex-col md:flex-row gap-2 mb-4">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto md:contents">
            <div className="flex-1 md:flex-none flex items-center gap-1 overflow-x-auto pb-2 md:pb-0 no-scrollbar md:no-scroll-reset w-full md:w-auto -mx-2 px-2 md:mx-0 md:px-0">
              <div className="hidden md:block h-8 w-px bg-slate-200 dark:bg-white/10 mx-2 shrink-0" />
              <button
                onClick={() => applyPreset("all")}
                className={`shrink-0 px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 cursor-pointer ${
              ...
              <button
                ...
                className={`shrink-0 p-2 rounded-xl transition-all duration-200 cursor-pointer ${
              ...
              >
                <Star
                  className={`w-5 h-5 ${activePreset === "favorites" ? "fill-current" : ""}`}
                />
              </button>
              <button
                onClick={() => applyPreset("due")}
                className={`shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-semibold transition-all duration-200 cursor-pointer ${
                  activePreset === "due"
            ...
            <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
              <PopoverTrigger asChild>
                <button
                  className={`shrink-0 w-10 h-10 flex items-center justify-center rounded-xl border border-slate-200/50 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors relative cursor-pointer ${activeFilterCount > 0 ? "text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20" : "text-slate-500 dark:text-slate-400"}`}
                >
              ...
              <PopoverContent
                className="w-80 p-5 rounded-2xl shadow-2xl backdrop-blur-xl bg-white/95 dark:bg-slate-900/95 border border-slate-200 dark:border-slate-700"
                align="end"
              >
