          ...
          <div className="flex items-center gap-2 w-full md:w-auto md:contents">
            ...
            <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
              <PopoverTrigger asChild>
                <button
                  className={`flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-xl border border-slate-200/50 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors relative cursor-pointer ${activeFilterCount > 0 ? "text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20" : "text-slate-500 dark:text-slate-400"}`}
                >
